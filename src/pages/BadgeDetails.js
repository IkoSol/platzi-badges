            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <div>
                            <button className="btn btn-danger" to={`/badges/${badge.id}/edit`} onClick={props.onOpenModal}>Delete</button>
                            <DeleteBadgeModal onDeleteBadge={props.onDeleteBadge} onClose={props.onCloseModal} isOpen={props.modalIsOpen} />
                        </div>
                    </div>
                </div>
            </div>
